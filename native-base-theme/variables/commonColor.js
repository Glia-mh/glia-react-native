...
export default {
  ...
  tabActiveBgColor: (platform === 'ios') ? '#1569f4' : undefined,
    ...
    // Tab
  tabDefaultBg: '#2874F0',
  topTabBarTextColor: '#50E3C2',
  topTabBarActiveTextColor: '#50E3C2',
  ...
  topTabBarActiveBorderColor: '#fff',
    ...
    // Header
  toolbarBtnColor: '#50E3C2',
  toolbarDefaultBg: '#2874F0',
  toolbarHeight: (platform === 'ios') ? 64 : 56,
  toolbarIconSize: (platform === 'ios') ? 20 : 22,
  toolbarSearchIconSize: (platform === 'ios') ? 20 : 23,
  toolbarInputColor: (platform === 'ios') ? '#50E3C2' : '#fff',
  searchBarHeight: (platform === 'ios') ? 30 : 40,
  toolbarInverseBg: '#222',
  toolbarTextColor: '#D8D8D8',
